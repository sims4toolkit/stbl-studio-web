<footer
  class="w-100 py-12 text-center flex flex-col gap-10 text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-900"
>
  <div class="flex flex-col gap-4">
    ...
    <p>
      <a href="https://frankkmods.com" target="_blank" class="text-brand-frankk"
        >Frankk's Mods</a
      >
      |
      <a
