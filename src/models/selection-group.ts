export default class SelectionGroup<T> {
  ...
  get selectMode(): boolean { return this._selectMode; }
  set selectMode(value: boolean) {
    this._selectMode = value;
    if (!value) this.deselectAll();
  }
  ...
  constructor(readonly selectables: T[], readonly key: string) {
  ...
  toggleValue(value: T) {
    ...
    this._selections = this._selections; // needed for svelte
  }
}
